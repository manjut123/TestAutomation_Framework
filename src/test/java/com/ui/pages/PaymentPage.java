...
public class PaymentPage extends BrowserUtility{
	...
	private static final By PAYMENT_BY_BANK_BUTTON_LOCATOR=By.xpath("//a[@title='Pay by bank wire']");
	private static final By CONFIRM_PAYMENT_BUTTON_LOCATOR=By.xpath("//p[contains(@class,'cart_navigation')]//button[@type='submit']");
	...
	{
		clickOn(PAYMENT_BY_BANK_BUTTON_LOCATOR);
