...
public class InvalidCredLoginTest extends TestBase {
	...
	private static final String INVALID_EMAIL_ADDRESS = "manjute@gmail.com";
	private static final String INVALID_PASSWORD = "pasert322!";

	@Test(description = "Verify if the proper error message is shown for the user when they enter invalid credentials ", groups = {
			"e2e", "sanity", "smoke" })
	public void loginTest() {

		assertEquals(homePage.goToLoginPage().doLoginWithInvalidCredentials
